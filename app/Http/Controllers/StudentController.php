...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'student_image'         =>  'required|image|mimes:jpg,png,jpeg,gif,svg|max:5120|dimensions:min_width=100,min_height=100,max_width=1000,max_height=1000',
            'student_gender'          =>  'required',
            'student_skills'         =>  'required',
        ]);
        ...
        $student->student_skills = json_encode($request->student_skills);
    ...
    public function update(Request $request, Student $student)
    {
        ...
        $student->student_skills = $request->student_skills;

        $student->student_image = $student_image;

        $student->save();

        return redirect()->route('students.index')->with('success', 'Data has been updated successfully');
    }
